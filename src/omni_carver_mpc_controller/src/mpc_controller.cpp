 ...
 */
 ...
 #include "omni_carver_mpc_controller/mpc_controller.hpp"
 #include "nav2_util/geometry_utils.hpp"

 #include "omni_carver_mpc_controller/mpc_utils.hpp"
 ...
 void MPCController::cleanup()
 {
   RCLCPP_INFO(
     logger_,
     "Cleaning up controller: %s of type mpc_controller::MPCController",
     plugin_name_.c_str());
   global_pub_.reset();
 }
 ...
 void MPCController::activate()
 {
   RCLCPP_INFO(
     logger_,
     "Activating controller: %s of type mpc_controller::MPCController\"  %s",
 ...
 void MPCController::deactivate()
 {
   RCLCPP_INFO(
     logger_,
     "Dectivating controller: %s of type mpc_controller::MPCController\"  %s",
     plugin_name_.c_str(),plugin_name_.c_str());
 ...
 nav_msgs::msg::Path
 MPCController::transformGlobalPlan(
   const geometry_msgs::msg::PoseStamped & pose)
 {
 ...
 PLUGINLIB_EXPORT_CLASS(omni_carver_mpc_controller::MPCController, nav2_core::Controller)